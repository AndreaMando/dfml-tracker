...
const translations: Record<Lang, Record<string, string>> = {
  ...
  it: {
    ...
    "Back to players": "Torna ai giocatori",
    "Back to rosters": "Torna alle rose",
    "Back to participants": "Torna ai partecipanti",
    "Back to seasons": "Torna alle stagioni",
    "Back to market": "Torna al mercato",
    ...
    "Spent": "Spesi",
    "Sell": "Vendi",
    "Current value": "Quotazione attuale",
    "Sort by": "Ordina per",
    "Most recent": "Più recenti",
    "The team name is set on the Participants page": "Il nome della fantasquadra si imposta nella pagina Partecipanti",
    ...
    "Formation": "Modulo",
    "Show lineups": "Mostra formazioni",
    "Hide lineups": "Nascondi formazioni",
    "No lineup submitted yet.": "Formazione non ancora disponibile.",
    "Bench": "Panchina",
    "s.v.": "s.v.",
    ...
    "Penalties scored": "Rigori segnati",
    "Own goals": "Autogol",
    ...
    "Forward": "Attaccante",
    "Career stats": "Statistiche di carriera",
    ...
    // Seasons
    "Season created": "Stagione creata",
    "Import teams from a previous season": "Importa squadre da una stagione precedente",
    "Optional — carry over rosters, paid prices and remaining credits (plus the end-of-season bonus) from a finished season.":
      "Facoltativo — riporta rose, prezzi pagati e crediti rimasti (più il bonus di fine stagione) da una stagione conclusa.",
    "Source season": "Stagione sorgente",
    "Select a season": "Seleziona una stagione",
    "Final rank": "Piazzamento finale",
    "Credits bonus": "Bonus crediti",
    "Import selected teams": "Importa squadre selezionate",
    "Importing teams": "Importazione squadre",
    "Skip, start from scratch": "Salta, inizia da zero",
    "Import summary": "Riepilogo import",
    "Players not carried over (transferred out of Serie A)": "Giocatori non riportati (trasferiti fuori Serie A)",
    "Go to seasons": "Vai a Stagioni",
    "No finished seasons to import from yet.": "Nessuna stagione conclusa da cui importare ancora.",
    "Create Season": "Crea stagione",
