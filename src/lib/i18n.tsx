...
const translations: Record<Lang, Record<string, string>> = {
  ...
  it: {
    ...
    "Finance & Penalties": "Finanza e Penalità",
    "Keep track of league fees, prizes, penalties and transaction balance.":
      "Tieni traccia di quote, premi, penalità e bilancio delle transazioni della lega.",
    "Edit": "Modifica",
    "Standings penalties": "Penalità in classifica",
    "Points deducted from a fantasy team's final standings, entered manually.":
      "Punti sottratti dalla classifica finale di una fantasquadra, inseriti a mano.",
    "Add penalty": "Aggiungi penalità",
    "Delete this penalty?": "Eliminare questa penalità?",
    "e.g. Missing U21 player": "es. Giocatore U21 mancante",
    "Includes a standings penalty": "Include una penalità in classifica",
    "credits": "crediti",
    ...
    // Fixtures / Scores
    "Results": "Risultati",
    "Results & Votes": "Risultati e voti",
    "Review matchday results and vote-based scoring summaries.": "Rivedi i risultati di giornata e i riepiloghi basati sui voti.",
    "Fixtures": "Partite",
    "Matches for this matchday.": "Partite di questa giornata.",
    "Cup": "Coppa",
    "Cup fixtures for this matchday.": "Partite di coppa per questa giornata.",
    "Quarterfinals - First leg": "Quarti di finale - Andata",
    "Quarterfinals - Second leg": "Quarti di finale - Ritorno",
    "Semifinals - First leg": "Semifinali - Andata",
    ...
    "League": "Campionato",
    "Cup registration fee": "Quota Coppa",
    "Per participant, added on top of the league fee.": "Per partecipante, in aggiunta alla quota campionato.",
    "Cup prizes": "Premi Coppa",
    "Winner": "Vincitore",
    "Runner-up": "Finalista",
    "Losing semifinalists": "Semifinalisti perdenti",
    "each": "ciascuno",
    "Remove": "Rimuovi",
    "Home": "Casa",
    "Away": "Trasferta",
